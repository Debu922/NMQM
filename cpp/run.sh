...
./output/main -dims 1 -Nx  54  -iter   10  -timesteps 1000 -verbose 1 -verify 1 >> output.txt
...
./output/main -dims 2 -Nx  54  -iter   10  -timesteps 1000 -verbose 1 -verify 1 >> output.txt
...
./output/main -dims 3 -Nx  54  -iter   10  -timesteps 10 -verbose  1 -verify 1 >> output.txt
